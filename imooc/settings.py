...
INSTALLED_APPS = [
    ...
    'xadmin',
    'crispy_forms',
    'captcha',   # 验证码包，需要在url，form，view，html中引入、配置
    'pure_pagination',
]
...
# 发送邮件的邮箱配置
EMAIL_HOST = 'smtp.sina.com'  # 邮箱的SMTP服务器地址
EMAIL_PORT = 25     # 默认值
EMAIL_HOST_USER = 'online_learn_edu@sina.com'  # 登录用户
EMAIL_HOST_PASSWORD = 'WZQwzq+123'
EMAIL_USE_TLS = True   # 默认
EMAIL_FROM = 'online_learn_edu@sina.com'  # 和user名称保持一致，指明发件人，如果不一致可能会出错
